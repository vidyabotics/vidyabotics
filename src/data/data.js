...
// vidyabotics data configuration
// Course demo videos can be added inside each course using demoVideos: []
...
export const siteConfig = {
  ...
  shortDescription:
    "Build in-demand technology skills with practical training in Data Analytics, AI, Data Science, Coding, and Robotics. Learn from experts, work on real projects, and prepare for the future.",
  logoText: "vidyabotics",
  logoImage: "/logo.png",

  contact: {
    phoneDisplay: "+91 9608396491",
    phoneDial: "+91 9608396491",
    whatsappNumber: "+919608396491",
    email: "vidyabotics@gmail.com",
    ...
    mapEmbedUrl:
      "https://www.google.com/maps?q=Tarwara,+Siwan,+Bihar&output=embed",
  },

  socials: {
    instagram: "https://instagram.com/vidyabotics",
    youtube: "https://youtube.com/@vidyabotics",
    linkedin:
      "https://www.linkedin.com/company/vidyabotics/about/?viewAsMember=true",
    facebook: "https://facebook.com/vidyabotics",
  },
...
export const formLinks = {
  enrollNow:
    "https://docs.google.com/forms/d/e/1FAIpQLSddkRJ_Ddo3BThizcfESiW1KSy8lQZEwiN4eJ9YqkY8r_Ed3w/viewform?usp=publish-editor",

  serviceInquiry: "https://forms.gle/REPLACE_ME_SERVICE_FORM",

  contactGeneral:
    "https://docs.google.com/forms/d/e/1FAIpQLScbbr4rr7NLgZJ829YGBQ5ik48Rig5VsNEwRY1dZ4lzGvjvKQ/viewform?usp=publish-editor",
};
...
export const courses = [
  {
    ...
    learn: [
      {
        week: "Part 1",
        title: "Why the future is changing",
        topics:
          "Understand why AI and new technology are reshaping jobs, and why being ready matters now.",
      },
      {
        week: "Part 2",
        title: "Meet Artificial Intelligence",
        topics:
          "What AI actually is, in simple terms, and where you already use it every day.",
      },
      {
        week: "Part 3",
        title: "Learn smarter with AI",
        topics:
          "Use AI tools to study faster, understand tough topics, and revise more effectively.",
      },
      {
        week: "Part 4",
        title: "Prompt engineering basics",
        topics:
          "Ask AI tools better questions to get better, more useful answers.",
      },
      {
        week: "Part 5",
        title: "Tools every student should know",
        topics: "A quick tour of the AI tools worth learning first.",
      },
      {
        week: "Part 6",
        title: "Staying safe online",
        topics:
          "Protect your data, spot scams, and build safe digital habits.",
      },
      {
        week: "Part 7",
        title: "Planning your career",
        topics:
          "A simple roadmap for what to do after Class 10 and 12.",
      },
      {
        week: "Part 8",
        title: "Government vs private careers",
        topics:
          "Compare paths so you can make an informed choice.",
      },
      {
        week: "Part 9",
        title: "Resume and LinkedIn basics",
        topics:
          "Put together a simple resume and profile that stands out.",
      },
      {
        week: "Part 10",
        title: "Scholarships and opportunities",
        topics:
          "Find competitions, scholarships and programs worth applying to.",
      },
      {
        week: "Part 11",
        title: "Robotics and emerging tech",
        topics:
          "A first look at robotics and other technologies shaping the future.",
      },
      {
        week: "Part 12",
        title: "Live demo and Q&A",
        topics:
          "See AI in action live and get your questions answered.",
      },
    ],
    ...
    learn: [
      {
        ...
        topics:
          "Clean, organise and analyse data using formulas, pivot tables and charts.",
      },
      {
        week: "Week 3-4",
        title: "SQL fundamentals",
        topics:
          "Write queries to filter, join and summarise data stored in databases.",
      },
      {
        week: "Week 5-7",
        title: "Python for data analysis",
        topics:
          "Use Python to load, clean and explore real datasets.",
      },
      {
        week: "Week 8-9",
        title: "Power BI dashboards",
        topics:
          "Turn raw data into interactive dashboards that tell a clear story.",
      },
      {
        week: "Week 10-11",
        title: "Data cleaning and visualisation",
        topics:
          "Handle messy, real-world data and present findings with clear charts.",
      },
      {
        week: "Week 12",
        title: "Capstone project",
        topics:
          "Analyse a complete dataset end-to-end and present your insights.",
      },
    ],
    ...
    learn: [
      {
        ...
        title: "Meet Python",
        topics:
          "Install Python, write your first program, and learn variables, data types, input and output.",
      },
      {
        week: "Week 2",
        title: "Operators and strings",
        topics:
          "Work with operators, type casting, and string methods.",
      },
      {
        week: "Week 3",
        title: "Making decisions",
        topics:
          "Use conditional statements to make your programs respond differently to different inputs.",
      },
      {
        week: "Week 4",
        title: "Loops",
        topics:
          "For and while loops, break, continue, pass, and pattern problems with nested loops.",
      },
      {
        week: "Week 5",
        title: "Lists, tuples and sets",
        topics:
          "Store and work with groups of values using lists, tuples, sets and their built-in methods.",
      },
      {
        week: "Week 6",
        title: "Dictionaries and comprehensions",
        topics:
          "Look up data by key with dictionaries, and write shorter code with comprehensions.",
      },
      {
        week: "Week 7",
        title: "Functions",
        topics:
          "Write reusable functions with parameters, return values, scope, *args/**kwargs and lambda functions.",
      },
      {
        week: "Week 8",
        title: "Map, filter and files",
        topics:
          "Process data with map, filter and reduce, and read/write files, CSV and JSON.",
      },
      {
        week: "Week 9",
        title: "Handling errors",
        topics:
          "Catch and handle exceptions gracefully, and create your own custom exceptions.",
      },
      {
        week: "Week 10",
        title: "Object-oriented programming",
        topics:
          "Classes, objects, constructors, inheritance, polymorphism, encapsulation and dunder methods.",
      },
      {
        week: "Week 11",
        title: "Modules and advanced tools",
        topics:
          "Use pip and virtual environments, work with datetime, iterators, generators, decorators and regular expressions.",
      },
      {
        week: "Week 12",
        title: "Capstone project",
        topics:
          "Plan, build and present a real-world Python project using everything you've learned.",
      },
    ],
    ...
    learn: [
      {
        ...
        topics:
          "Understand what machine learning is and how it fits into real applications.",
      },
      {
        week: "Week 3-4",
        title: "Data preprocessing",
        topics:
          "Clean, transform and prepare data so it's ready for a model to learn from.",
      },
      {
        week: "Week 5-7",
        title: "Regression models",
        topics:
          "Predict numeric outcomes using linear and other regression techniques.",
      },
      {
        week: "Week 8-10",
        title: "Classification models",
        topics:
          "Build models that sort data into categories, like spam vs not spam.",
      },
      {
        week: "Week 11-12",
        title: "Model evaluation",
        topics:
          "Measure how well a model performs and improve it.",
      },
      {
        week: "Week 13-15",
        title: "End-to-end ML project",
        topics:
          "Take a real dataset from raw data to a working, evaluated model.",
      },
    ],
    ...
    learn: [
      {
        ...
        topics:
          "Robotics safety, understanding voltage/current/resistance, and core components like batteries, LEDs, switches and buzzers.",
      },
      {
        week: "Month 1",
        title: "Circuits and components",
        topics:
          "Conductors and insulators, resistors, capacitors, diodes, transistors, and building circuits on a breadboard.",
      },
      {
        week: "Month 2",
        title: "Sensors and motors",
        topics:
          "ICs, the 555 timer, and working with IR, LDR, ultrasonic, gas and rain sensors alongside DC and servo motors.",
      },
      {
        week: "Month 2",
        title: "Arduino programming",
        topics:
          "Arduino UNO hardware, pin configuration, and writing your first programs in the Arduino IDE.",
      },
      {
        week: "Month 3",
        title: "Building and controlling robots",
        topics:
          "Control LEDs, buzzers, motors and sensors together, design circuits, and troubleshoot problems.",
      },
      {
        week: "Month 3",
        title: "Assembly and wireless control",
        topics:
          "Assemble and test a full robot, then add Bluetooth and Wi-Fi control plus an intro to IoT.",
      },
      {
        week: "Month 4",
        title: "Capstone projects",
        topics:
          "Build hands-on projects like an automatic street light, smart dustbin, obstacle-avoiding robot and more.",
      },
    ],
    ...
    learn: [
      {
        ...
        topics:
          "Explore the Scratch interface, sprites and backdrops, and start using motion, looks, sound and events.",
      },
      {
        week: "Month 1",
        title: "Sequences and animation",
        topics:
          "Build sequences and loops to create your first animations.",
      },
      {
        week: "Month 2",
        title: "Logic and data",
        topics:
          "Use if/else statements, variables, operators and lists to make projects that react and remember.",
      },
      {
        week: "Month 2",
        title: "Messages and cloning",
        topics:
          "Use broadcast messages and cloning to build more advanced interactions.",
      },
      {
        week: "Month 3",
        title: "Games with scoring",
        topics:
          "Add user input, timers and scoring to turn projects into real games.",
      },
      {
        week: "Month 3",
        title: "Design and debugging",
        topics:
          "Learn game design basics and how to find and fix bugs in your projects.",
      },
      {
        week: "Month 4",
        title: "Storytelling and final project",
        topics:
          "Create interactive stories, explore advanced Scratch features, and build and present a final project.",
      },
    ],
...
export const posts = [
  {
    id: "post-1",
    title:
      "Introducing vidyabotics — A journey towards future-ready technology learning",
    date: "2026-07-26",
    excerpt:
      "We are excited to begin our journey of making technology learning practical and accessible through AI, Data Science, Coding, Robotics, and emerging technologies.",
    platform: "LinkedIn",
...
export const stats = [
  ...
  },
  {
    label: "For",
    value:
      "Students (School & College), Graduates & Freshers, and Working Professionals",
  },
];